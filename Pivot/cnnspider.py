...
class CnnSpider(scrapy.Spider):
    ...
    def __init__(self):
        ...
        search_input.send_keys("Coronavirus") # type in the search term
        ...
        # start turning pages
        i = 0
        while i < 200: # How many pages will be scraped
            i += 1
    ...
    def parse(self, response):
        for page in self.html:
            ...
            for result in results:
                ...
                if ("Covid" in title) | ("coronavirus news" in title) | ("http" in title):
